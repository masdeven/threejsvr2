export const quizData = [
  ...
  {
    question:
      "What technology followed the use of vacuum tubes in the 1950s, allowing computers to become smaller and more efficient?",
    answers: [
      "Integrated Circuits",
      "Transistors",
      "Microprocessors",
  ...
  {
    question:
      "According to the text, what 21st-century technology enables data access from anywhere?",
    answers: [
  ...
  {
    question:
      "Why are LED monitors the most commonly used type today, according to the description?",
    answers: [
      "They have the highest refresh rates.",
      "They are energy-efficient and provide good image quality.",
      "They are available in the largest sizes.",
      "They have the best color contrast.",
    ],
    correctAnswerIndex: 1,
  },
  // == Keyboard ==
  ...
  // {
  //   question:
  //     "What is the main advantage of an SSD (Solid State Drive) over an HDD (Hard Disk Drive)?",
  //   answers: [
  //     "Larger capacity",
  ...
  // {
  //   question:
  //     "Which type of printer uses powdered toner and is ideal for high-volume text documents?",
  //   answers: [
  //     "Inkjet Printer",
  //     "Dot Matrix Printer",
  //     "3D Printer",
